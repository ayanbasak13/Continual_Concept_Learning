...
from runners.utils import show_all_variables
from runners.utils import check_folder
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='mnist', choices=['mnist', 'fashion-mnist', 'celebA', 'emnist'],
    ...
    parser.add_argument('--result_dir', type=str, default='Autoencoder',
...
def main():
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
        ...
        _ = gan.inference(task=task)
        # print(predictions)

        # gan.compute_means_stds(task=task)


        # visualize learned generator
        gan.visualize_results(args.epoch-1, task=task)
